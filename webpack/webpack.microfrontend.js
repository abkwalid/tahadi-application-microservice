    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          '@angular/core': { singleton: true, strictVersion: true, requiredVersion: '16.2.9' },
          '@angular/common': { singleton: true, strictVersion: true, requiredVersion: '16.2.9' },
          '@angular/common/http': { singleton: true, strictVersion: true, requiredVersion: '16.2.9' },
          '@angular/router': { singleton: true, strictVersion: true, requiredVersion: '16.2.9' },
          '@angular/forms': { singleton: true, strictVersion: true, requiredVersion: '16.2.9' },
          '@angular/platform-browser': { singleton: true, strictVersion: true, requiredVersion: '16.2.9' },
          ...
          dayjs: { singleton: true, strictVersion: true, requiredVersion: '1.11.10' },
          ...
          'zone.js': { singleton: true, strictVersion: true, requiredVersion: '0.13.3' },
